...
def products(request):
    ...
    context = {'title':'Mahsulotlar' ,'products':products}
...
def delete_product(request, id):
    ...
    messages.success(request, 'mahsulot o`chirildi!', 'success')
...
def edit_product(request, id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            messages.success(request, 'Mahsulot tahrirlandi', 'success')
            return redirect('dashboard:products')
    else:
        form = EditProductForm(instance=product)
    context = {'title': 'Mahsulotni tahrirlash', 'form':form}
...
def add_category(request):
    ...
    context = {'title':"Bo'lim qo'shish", 'form':form}
...
def orders(request):
    ...
    context = {'title':'Buyurtmalar', 'orders':orders}
...
def order_detail(request, id):
    ...
    context = {'title':'Buyurtma batafsil', 'items':items, 'order':order}
